...
public class UnderwaterWorldPanel extends JPanel {
    private MainWindow mainWindow;
    private Player player;
    private Submarine currentEnemy;
    ...
    public UnderwaterWorldPanel(MainWindow mainWindow, Player player) {
    ...
    private void initComponents() {
        ...
        backgroundImage = ImageLoader.loadImage("src/main/resources/assets/underwater_background.jpg");

        // Load and set player image
        String predatorImagePath = "src/main/resources/assets/" + player.getPredator().getName().toLowerCase() + ".png";
        ImageIcon predatorIcon = new ImageIcon(ImageLoader.loadImage(predatorImagePath));
    ...
    private void encounterEnemy() {
        currentEnemy = new Submarine();
        enemyHealthLabel.setText("Enemy Health: " + currentEnemy.getHealth());

        // Load and set enemy image
        ImageIcon enemyIcon = new ImageIcon(ImageLoader.loadImage("/ch/intellon/junglegame/assets/submarine.png"));
